  ...
  <div class="container top64">
    <div class="col-md-8">
      ...
      <article class="hal">
                ...
                <div class="media">
                  <div class="media-kiri">
                    <div class="content-avatar">
                      <img src="../storage/{{$author->avatar}}" class="lazy">
                    </div>
                  </div>
                  <div class="media-body">
                    <div class="content-name">
                        <a href="{{ url('author/'.$author->id) }}" class="link">{{ $author->name }}</a>
                            <?php
                                $id = $author->id;
                                $point = App\DetailUser::where('users_id','=',$id)->first();
                              ?>
                              @if(count($point) === 1)
                              <div class="post-tentang"><p>{{ $point->tentang }}</p></div>
                                @endif
        ...
        <img src="../storage/{{ $post->image}}" alt="{{ $post->title }}" class="img-responsive full-width lazy" style="margin:auto;">
        <div class="long-iklan">
            <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                <!-- Iklan Link Responsive -->
                <ins class="adsbygoogle"
	...
	<div class="content-body">
                ...
                <div class="col-md-4">
                  <div class="post-item">
                    <div class="post-thumb">
                      <a href="{{ url('artikel/'.$event->slug) }}"><img src="../storage/{{ $event->image }}" class="img-responsive lazy"></a>
                    </div>
                    <div class="post-body">
      ...
      <div class="col-md-4">
        ...
        <div class="widget">
          ...
          <div class="img-widget">
            <div class="instagram">
              <a href="https://www.bukalapak.com/p/hobi-koleksi/buku/pengembangan-diri/1d2wu7v-jual-super-buku-psikotes-diktat-drilling-top-no-1-psikotes-gambar" target="_blank"><img src="{{ asset('gambar/product/PSIKOTES_GAMBAR.jpg') }}" style="box-shadow:0px 1px 8px #000; " alt=""></a>            </div>
          </div>
        </div>
        <br/>
        <br/>
